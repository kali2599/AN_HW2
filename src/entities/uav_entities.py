...
class Packet(Entity):
    ...
    def __init__(self, time_step_creation, simulator, event_ref: Event = None):
        ...
        # HOP COUNTS
        self.hops = []  # All the drones that have received/transmitted the packets
        self.n_hops = -1
        # self.last_2_hops = []
...
class Drone(Entity):
    ...
    def accept_packets(self, packets):
        ...
        for packet in packets:
            # packet.add_hop(self.identifier)
