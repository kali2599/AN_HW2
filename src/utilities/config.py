...
# ------------------------------------------- ROUTING MISC --------------------------------- #
HELLO_DELAY = 5  # int : how many time steps wait before transmit again a hello message
RECEPTION_GRANTED = 0.95  # float : the min amount of success to evaluate a neigh as relay
LIL_DELTA = 1  # INT:  > 0
OLD_HELLO_PACKET = 50
